          ...
          <div className="prose prose-lg mx-auto">
            ...
            <div className="my-12 space-y-12">
              ...
              <div className="bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <p>
                  Portal Digital Nagari Guguak Malalo ("Portal") dioperasikan
                  oleh Pemerintah Nagari Guguak Malalo. Dengan mengakses atau
                  menggunakan Portal ini, Anda menyetujui dan menyepakati untuk
                  terikat oleh syarat dan ketentuan yang ditetapkan di sini.
                </p>
                <p className="mb-0">
              ...
              <div className="bg-gray-50 rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <p>
                  Portal Digital Nagari Guguak Malalo disediakan "sebagaimana
                  adanya" dan "sebagaimana tersedia" tanpa jaminan apapun, baik
                  tersurat maupun tersirat. Kami tidak menjamin bahwa:
                </p>
                <ul className="space-y-2">
            ...
            <div className="bg-blue-50 border-l-4 border-[#7ca186] p-6 rounded-lg mt-10 mb-10">
              ...
              <p className="mb-0">
                ...
                di Portal dengan tanggal "Terakhir diperbarui" yang direvisi.
                Anda bertanggung jawab untuk secara berkala meninjau Syarat &
                Ketentuan ini untuk mengetahui adanya perubahan.
              </p>
            </div>
