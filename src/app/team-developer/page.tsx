...
const VGenIcon = ({ size }: { size: number }) => (
  <Image
    src="/VGen.png"
    alt="VGen"
    width={size}
...
const WebtoonIcon = ({ size }: { size: number }) => (
  <Image
    src="/webtoon.jpg"
    alt="Webtoon"
    width={size}
...
const CoordinatorCard = ({
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-[#7ca186]/10 border-2 border-blue-200 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 rounded-lg">
      {/* Background Pattern */}
...
export default function TeamDeveloper() {
  ...
  return (
    <main className="pt-24 md:pt-28">
      {/* Team Members Section - Updated to match reference */}
